...
class MasterViewController: UITableViewController, LoginViewDelegate, SFSafariViewControllerDelegate {
    ...
    //This method will call when you press Logout Button.
    ...
    override func viewDidLoad() {
        ...
        button.setImage(UIImage(named: "Logout Button"), for: UIControlState.normal)
        //add function for button
        button.addTarget(self, action: #selector(MasterViewController.logOutButtonPressed), for: UIControlEvents.touchUpInside)
        //set frame
    ...
    func showOAuthLoginView() {
        ...
        self.present(loginVC, animated: false /*true*/, completion: nil)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let gistDescription = gist.gistDescription,
            !gistDescription.isEmpty {
            cell.textLabel?.text = gistDescription
        } else {
            cell.textLabel?.text = " "
        }
